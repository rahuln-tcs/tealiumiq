...
class Settings extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['content_type_profile'] = [
      '#type' => 'textarea',
      '#title' => $this->t('Tag profile with content types'),
      '#default_value' => $settings->get('content_type_profile'),
      '#description' => $this->t('Please add the profile ID along with content
        type name as mentioned format. For e.g <em>content_type|profile_id</em>.
        <br>You can add multiple profile IDs in new line.'),
    ];
    $form['environment'] = [
      '#type' => 'radios',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('tealiumiq.settings')
      ...
      ->set('content_type_profile', $form_state->getValue('content_type_profile'))
